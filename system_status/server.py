...
def get_prometheus_data() -> list[PrometheusData]:
    ...
    try:
        ...
        for service_dict in result_list:
            maybe_instance = service_dict.get("metric",{}).get("instance", "NO INSTANCE AVAILABLE")
            ...
            service = PrometheusData(maybe_instance, maybe_job, is_up, timestamps_and_values)
...
def page_generator(request: Request):
    ...
    return (templates.TemplateResponse
            ("my_template.html",
             {"request": request, "data": data, "fetch_time": fetch_time}))
